...
def generate_transaction():
    # Generate random amount (more likely to be fraudulent if higher)
...
def generate_and_send_transactions(count=20):
    print(f"Generating and sending {count} random transactions...")
    success_count = 0
    ...
    print(f"Successfully processed {success_count} out of {count} transactions")

if __name__ == "__main__":
    generate_and_send_transactions(20)
